...
func (m *MockUserRepository) EditById(ctx context.Context, u domain.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EditById", ctx, u)
	ret0, _ := ret[0].(error)
	return ret0
}

// EditById indicates an expected call of EditById.
func (mr *MockUserRepositoryMockRecorder) EditById(ctx, u any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EditById", reflect.TypeOf((*MockUserRepository)(nil).EditById), ctx, u)
}
